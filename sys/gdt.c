...
#define GDT_CS        (0x00180000000000)  */
/*** code segment descriptor ***//*

#define GDT_DS        (0x00100000000000)  */
/*** data segment descriptor ***//*


#define C             (0x00040000000000)  */
/*** conforming ***//*

#define DPL0          (0x00000000000000)  */
/*** descriptor privilege level 0 ***//*

#define DPL1          (0x00200000000000)  */
/*** descriptor privilege level 1 ***//*

#define DPL2          (0x00400000000000)  */
/*** descriptor privilege level 2 ***//*

#define DPL3          (0x00600000000000)  */
/*** descriptor privilege level 3 ***//*

#define P             (0x00800000000000)  */
/*** present ***//*

#define L             (0x20000000000000)  */
/*** long mode ***//*

#define D             (0x40000000000000)  */
/*** default op size ***//*

#define W             (0x00020000000000)  */
...
/* segment extent (msb) *//*
  ...
  uint64_t sd_xx1 :3; */
/* avl, long and def32 (not used) *//*

  uint64_t sd_gran :1; */
/* limit granularity (byte/page) *//*

  uint64_t sd_hibase :40; */
/* segment base address (msb) *//*
...
/*** user data segment descriptor ***//*
  ...
  GDT_CS | P | DPL3 | L, */
/*** user code segment descriptor (64-bit) ***//*
